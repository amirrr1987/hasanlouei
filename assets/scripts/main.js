...
createApp({
  data() {
    return {
      ...
      products: [
        {
          image: './assets/images/products/web/pistachio.jpg', name: 'پسته',          desc: 'پسته کله‌قوچی و احمدآقایی',    cat: 'nuts',  badge: 'پرفروش' },
        { image: './assets/images/products/web/walnut.jpg', name: 'گردو',          desc: 'گردو کاغذی کرمانشاه',          cat: 'nuts',  badge: '' },
        { image: './assets/images/products/web/almond.jpg', name: 'بادام درختی',   desc: 'بادام ایرانی تازه و خشک',      cat: 'nuts',  badge: '' },
        { image: './assets/images/products/web/hazelnut.jpg', name: 'فندق',          desc: 'فندق خام و بوداده گیلان',      cat: 'nuts',  badge: 'تازه' },
        { image: './assets/images/products/web/raisins.jpg', name: 'کشمش',          desc: 'کشمش سبز، قرمز و انگوری',     cat: 'dried', badge: '' },
        { image: './assets/images/products/web/dried-dates.jpg', name: 'خرما',          desc: 'خرما مضافتی و پیارم',          cat: 'dried', badge: 'پرفروش' },
        { image: './assets/images/products/web/dried-figs.jpg', name: 'انجیر خشک',    desc: 'انجیر خشک استهبان',            cat: 'dried', badge: '' },
        { image: './assets/images/products/web/dried-barberry.jpg', name: 'زرشک',          desc: 'زرشک بیرجند درجه یک',         cat: 'dried', badge: '' },
        { image: './assets/images/products/web/peanut.jpg', name: 'بادام زمینی',  desc: 'بادام زمینی ایرانی و وارداتی', cat: 'seeds', badge: '' },
        { image: './assets/images/products/web/sunflower-seeds.jpg', name: 'تخمه آفتابگردان', desc: 'تخمه آفتابگردان', cat: 'seeds', badge: '' },
      ],
      whyItems: [
